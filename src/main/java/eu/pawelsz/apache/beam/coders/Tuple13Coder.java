...
public class Tuple13Coder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> extends StandardCoder<Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> {
  ...
  @JsonCreator
  public static Tuple13Coder<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> of(
      @JsonProperty(PropertyNames.COMPONENT_ENCODINGS)
          List<Coder<?>> components) {
    Preconditions.checkArgument(components.size() == 13,
        "Expecting 13 components, got" + components.size());
    return of(
        components.get(0),
        components.get(1),
        components.get(2),
  ...
  @Override
  public void encode(Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> tuple, OutputStream outputStream, Context context)
  ...
  @Override
  public Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> decode(InputStream inputStream, Context context)
      throws CoderException, IOException {
    Context nestedContext = context.nested();
  ...
  public void verifyDeterministic() throws NonDeterministicException {
    verifyDeterministic("Coders must be deterministic", t0Coder, t1Coder, t2Coder, t3Coder, t4Coder, t5Coder, t6Coder, t7Coder, t8Coder, t9Coder, t10Coder, t11Coder, t12Coder);
  }
  ...
  @Override
  public Object structuralValue(Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> tuple) throws Exception {
  ...
  @Override
  public boolean isRegisterByteSizeObserverCheap(Tuple13<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> tuple, Context context) {
