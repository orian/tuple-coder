...
public class Tuple9Coder<T0, T1, T2, T3, T4, T5, T6, T7, T8> extends StructuredCoder<Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8>> {
  ...
  @Override
  public void encode(Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> tuple, OutputStream outStream)
  ...
  @Override
  public Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> decode(InputStream inputStream)
      throws CoderException, IOException {
  ...
  @Override
  public Object structuralValue(Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> tuple) {
  ...
  @Override
  public boolean isRegisterByteSizeObserverCheap(Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8> tuple) {
  ...
  @Override
  public TypeDescriptor<Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8>> getEncodedTypeDescriptor() {
    return new TypeDescriptor<Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8>>() {}
