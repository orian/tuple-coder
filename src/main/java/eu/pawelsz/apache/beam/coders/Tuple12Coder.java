...
public class Tuple12Coder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> extends StructuredCoder<Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> {
  ...
  @Override
  public void encode(Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> tuple, OutputStream outStream)
  ...
  @Override
  public Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> decode(InputStream inputStream)
      throws CoderException, IOException {
  ...
  @Override
  public Object structuralValue(Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> tuple) {
  ...
  @Override
  public boolean isRegisterByteSizeObserverCheap(Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> tuple) {
  ...
  @Override
  public TypeDescriptor<Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> getEncodedTypeDescriptor() {
    return new TypeDescriptor<Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>() {}
