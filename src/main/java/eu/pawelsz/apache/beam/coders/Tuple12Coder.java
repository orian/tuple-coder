...
public class Tuple12Coder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> extends StandardCoder<Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> {


  public static <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> Tuple12Coder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> of(
      Coder<T0> t0,
      Coder<T1> t1,
      Coder<T2> t2,
      Coder<T3> t3,
      ...
      Coder<T10> t10,
      Coder<T11> t11) {
    return new Tuple12Coder<>(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11);
  }

  @JsonCreator
  public static Tuple12Coder<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?> of(
      @JsonProperty(PropertyNames.COMPONENT_ENCODINGS)
          List<Coder<?>> components) {
    Preconditions.checkArgument(components.size() == 12,
        "Expecting 12 components, got" + components.size());
    return of(
        components.get(0),
        components.get(1),
        components.get(2),
  ...
  public static <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> List<Object> getInstanceComponents(
      Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> exampleValue) {
  ...
  @Override
  public void encode(Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> tuple, OutputStream outputStream, Context context)
      throws CoderException, IOException {
    if (tuple == null) {
      throw new CoderException("cannot encode a null Tuple12");
    }
  ...
  @Override
  public Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> decode(InputStream inputStream, Context context)
      throws CoderException, IOException {
    Context nestedContext = context.nested();
    ...
    return Tuple12.of(f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11);
  }

  @Override
  public List<? extends Coder<?>> getCoderArguments() {
    return Arrays.asList(t0Coder, t1Coder, t2Coder, t3Coder, t4Coder, t5Coder, t6Coder, t7Coder, t8Coder, t9Coder, t10Coder, t11Coder);  }

  @Override
  public void verifyDeterministic() throws NonDeterministicException {
    verifyDeterministic("Coders must be deterministic", t0Coder, t1Coder, t2Coder, t3Coder, t4Coder, t5Coder, t6Coder, t7Coder, t8Coder, t9Coder, t10Coder, t11Coder);
  }
  ...
  @Override
  public Object structuralValue(Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> tuple) throws Exception {
  ...
  @Override
  public boolean isRegisterByteSizeObserverCheap(Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> tuple, Context context) {
  ...
  @Override
  public void registerByteSizeObserver(Tuple12<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> tuple,
