...
public class Tuple7Coder<T0, T1, T2, T3, T4, T5, T6> extends StructuredCoder<Tuple7<T0, T1, T2, T3, T4, T5, T6>> {
  ...
  @Override
  public void encode(Tuple7<T0, T1, T2, T3, T4, T5, T6> tuple, OutputStream outStream)
  ...
  @Override
  public Tuple7<T0, T1, T2, T3, T4, T5, T6> decode(InputStream inputStream)
      throws CoderException, IOException {
  ...
  @Override
  public Object structuralValue(Tuple7<T0, T1, T2, T3, T4, T5, T6> tuple) {
  ...
  @Override
  public boolean isRegisterByteSizeObserverCheap(Tuple7<T0, T1, T2, T3, T4, T5, T6> tuple) {
  ...
  @Override
  public TypeDescriptor<Tuple7<T0, T1, T2, T3, T4, T5, T6>> getEncodedTypeDescriptor() {
    return new TypeDescriptor<Tuple7<T0, T1, T2, T3, T4, T5, T6>>() {}
