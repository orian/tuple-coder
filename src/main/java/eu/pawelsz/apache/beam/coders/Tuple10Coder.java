...
public class Tuple10Coder<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> extends StandardCoder<Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
  ...
  @JsonCreator
  public static Tuple10Coder<?, ?, ?, ?, ?, ?, ?, ?, ?, ?> of(
      @JsonProperty(PropertyNames.COMPONENT_ENCODINGS)
          List<Coder<?>> components) {
    Preconditions.checkArgument(components.size() == 10,
        "Expecting 10 components, got" + components.size());
    return of(
        components.get(0),
        components.get(1),
        components.get(2),
  ...
  @Override
  public void encode(Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> tuple, OutputStream outputStream, Context context)
  ...
  @Override
  public Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> decode(InputStream inputStream, Context context)
      throws CoderException, IOException {
    Context nestedContext = context.nested();
  ...
  public void verifyDeterministic() throws NonDeterministicException {
    verifyDeterministic("Coders must be deterministic", t0Coder, t1Coder, t2Coder, t3Coder, t4Coder, t5Coder, t6Coder, t7Coder, t8Coder, t9Coder);
  }
  ...
  @Override
  public Object structuralValue(Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> tuple) throws Exception {
  ...
  @Override
  public boolean isRegisterByteSizeObserverCheap(Tuple10<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> tuple, Context context) {
